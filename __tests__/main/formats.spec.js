...
describe("test registered formats", () => {
    ...
    test("ISODateTime registered format must be YYYY-MM-ddThh:mm:ss", () => {    
        expect(testFunction('ISODateTime', testDate)).toEqual('2022-09-22T02:25:53');
    });
});

describe("create new format", () => {
