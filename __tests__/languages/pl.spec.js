...
describe('should use polish language', () => {
  test('polish format of meridiem before 12', () => {
    testDate.setHours(3);
    expect(testFunction('A', testDate)).toEqual('rano');
  });

  test('should return polish format of meridiem after 12 should be empty', () => {
    testDate.setHours(13);
    expect(testFunction('A', testDate)).toEqual('');
  });

  test('should return polish months in nominative', () => {
  ...
  test('should return polish months in accusative', () => {
  ...
  test('should return polish months shortly nominative', () => {
  ...
  test('should return polish months shortly accusative', () => {
    'sty_lut_mar_kwi_maj_cze_lip_sie_wrz_paź_lis_gru'
      .split('_')
      .forEach((month, index) => {
        testDate.setMonth(index);
  ...
  test('should return polish days fully', () => {
  ...
  test('should return polish days shortly', () => {
