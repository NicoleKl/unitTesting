...
describe('should use czech language', () => {
  test('should return czech format of meridiem before 12', () => {
    testDate.setHours(3);
    expect(testFunction('A', testDate)).toEqual('dopoledne');
  });

  test('should return czech format of meridiem after 12', () => {
    testDate.setHours(13);
    expect(testFunction('A', testDate)).toEqual('odpoledne');
  });

  test('should return czech months in nominative', () => {
  ...
  test('should return czech months in accusative', () => {
  ...
  test('should return czech months shortly nominative', () => {
  ...
  test('should return czech months shortly accusative', () => {
    'led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro'
      .split('_')
      .forEach((month, index) => {
        testDate.setMonth(index);
  ...
  test('should return czech days fully', () => {
  ...
  test('should return czech days shortly', () => {
